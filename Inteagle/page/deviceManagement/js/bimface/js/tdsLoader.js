...
THREE.TDSLoader.prototype = {
    ...
    readMaterialEntry: function (data, path) {
        ...
        var chunk = this.readChunk(data);
        var next = this.nextChunk(data, chunk);
        var material = new CLOUD.CloudStandardMaterial(); //pll
        ...
        material.side = THREE.DoubleSide; //pll
    ...
    readMap: function (data, path) {
        ...
        while (next !== 0) {
            ...
            if (next === MAT_MAPNAME) {
                ...
                texture = loader.load(name, function (texture) {
                    texture.image = CLOUD.MaterialUtil.ensurePowerOfTwo(texture.image); //pll
                });
